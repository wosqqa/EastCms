(function() {
    ...
    var mobile_num, //手机号
        ...
        global_to = "//" + window.location.host + window.location.pathname,
        phone_url = "//plsms.dftoutiao.com",
        comment_url = "//aboutcomment.dftoutiao.com";
    //用户头像
    user_pic = user_pic_p();
    ...
    //获取地理位置 用作用户名
    if ($.cookie('userNameNew')) {
        var user_f = $.cookie('userNameNew');
        if(user_f == '' || user_f == null || user_f == 'undefined' ){
            user_f = '匿名网友';
        }
        ...
        function login_user(URL) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (userpic == '') {
                        $('#head_log_bg img').attr('src', '//mini.eastday.com/assets/images/head_log1.png');
                        userpic = '//mini.eastday.com/assets/images/head_log1.png';
                    } else {
    ...
    function user_pic_p() {
        return '//mini.eastday.com/assets/images/head_log1.png';
    }
