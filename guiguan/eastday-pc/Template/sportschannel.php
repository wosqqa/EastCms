...
<div class="header_cnt_detail clear-fix">
  <div class="header_cnt_l_detail clear-fix">
    <ul class="nav_detail clearfix">
      ...
      <li> <a href="http://video.eastday.com/" pdata="nav|mini_sportschannel|1|0" target="_blank">视频</a></li>
      <li><a href="/fashion.html" pdata="channel|nav|6|0" target="_blank">时尚</a></li>
      <li><a href="http://mil.eastday.com" pdata="channel|nav|7|0" target="_blank">军事</a></li>
  ...
  <div class="header_cnt_2_detail" id="channel_top_1">
    <!-- 广告位：嵩恒_头条_新闻页面_顶部通栏 -->
        <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_top_1.js"></script>
  </div>
</div>
    ...
    <div class="head_search_cnt_contain positionSearchCnt">
        <div class="head_search_cnt_left">
              <div class="detail_position">
                  <a href='javascript:;' class='detail_logo'><span><?= \Lib\Core::config('tiyu_type_map')[$channel][0] ?></span></a>
                  <a href="/" pdata="subchannel|wz|1|0">东方头条</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="/sports.html" pdata="subchannel|wz|2|0">体育</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="javascript:;"><?= \Lib\Core::config('tiyu_type_map')[$channel][0] ?>频道</a>
              </div>
        </div>
...
<div class='main_contain_cnt clear-fix'>
		...
		<div id="J_channel_right_sidebar" class='main_right clear-fix'>
          ...
          <!-- 广告位：默认渠道 新闻内页_300*250-->
              <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_right_2.js"></script>
          </div>          
  				...
  				<div class="gg_channel_r_b gg_right2" id="channel_right_3">
                    ...
                    <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_right_3.js"></script>
  				</div>
          <div class="gg_channel_r_b gg_right3" id="channel_right_4">
            <!-- 广告位：默认渠道 新闻内页_300*400    2447086-->
              <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_right_4.js"></script>
          </div>
          <div class="gg_channel_r_b gg_right4" id="channel_right_5">
            <!-- 广告位：默认渠道 新闻内页_300*250    2447090 -->
              <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_right_5.js"></script>
          </div>
          <div class="gg_channel_r_b gg_right5" id="channel_right_6">
            <!-- 广告位：默认渠道 新闻内页_300*250    2447088-->
              <script type="text/javascript" src="<?php echo __WWW_JS ?>resources/channel/channel_right_6.js"></script>
          </div>                              
		</div>
</div>
<div class="goto_top"><a id='gotop_btn' class='show_go_0' href="javascript:;"></a><a class='show_go_1' href="javascript:;"></a><div class="erwei_cnt"></div></div>
	<?php include 'footer.php'?>
<script src="<?php echo __WWW_JS ?>channel.js"></script>
<script  type="text/javascript">
  (function(){
    if (!channel_no_lunbo){
        setTimeout(function(){
...
<script type="text/javascript">
    ...
    if(coo_name == "2345xiaohua"){
    }else{
        var cpro_id = "u2218976";
    }
    document.write('<script src="http://cpro.baidustatic.com/cpro/ui/s.js" type="text/javascript"><\/script>');
</script>
