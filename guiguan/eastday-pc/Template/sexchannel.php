...
<head>
    ...
    <link rel="canonical" href="http://mini.eastday.com/sex.html" />
	<title>两性天地_东方头条网</title>
    ...
    <script type="text/javascript">
        ...
        var channel = 'sex';
        var newstype='sex';
        var channel_list_url = '//liangxing.dftoutiao.com/jsonpc/refresh';
        var channel_list_next_url = '//liangxing.dftoutiao.com/jsonpc/next';
    ...
    <div class="head_search_cnt_contain positionSearchCnt">
        <div class="head_search_cnt_left">
            <div class="detail_position">
                <a href='javascript:;' class='detail_logo'><img src="<?php echo __WWW_IMG ?>sex_logo.png" alt="两性天地" title='两性天地'></a>
            </div>
        </div>
...
<div style="display:none;">
    ...
    <script>
        var _hmt = _hmt || [];
        (function()
            { var hm = document.createElement("script"); hm.src = "//hm.baidu.com/hm.js?4d80833aca027199e068790d09c36e21"; var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(hm, s); }
        )();
    </script>
</div>
