			...
			success:function(data){
				...
				$.each(data.data,function(i,item){
                    ...
                    if(imgLength < 1){
                        ...
                        $li = $('<li class="J-has-share listNews-item-s1 clearfix">' +
                            '<div class="img fl">' +
                                '<a href="/a/' + url + '" pdata="channel|newsTimely|' + j +'|' + hotNews + '" target="_blank"><img class="animation" src="' + imgArr[0].src + '" alt="' + title + '" width="180" height="135"></a>' +
                            '</div><div class="info">' +
                                '<h3><a class="J-share-a" href="/a/' + url + '" pdata="channel|newsTimely|' + j +'|' + hotNews + '" target="_blank">' + title + '</a></h3>' +
                                '<p class="desc">' + brief + '...</p><p class="from">' + dateTime + ' 来源：' + source + '</p>' + bdShareStr + '</div>' +
                        '</li>');
                        ...
                        $li = $('<li class="J-has-share listNews-item-s2 clearfix">' +
                            ...
                            '<a class="fl" href="/a/' + url + '" pdata="channel|newsTimely|' + j +'|' + hotNews + '" title="' + title + '" target="_blank"><img class="animation" src="' + imgArr[0].src + '" alt="" width="200" height="150"></a>' +
                            '<a class="fl" href="/a/' + url + '" pdata="channel|newsTimely|' + j +'|' + hotNews + '" title="' + title + '" target="_blank"><img class="animation" src="' + imgArr[1].src + '" alt="" width="200" height="150"></a>' +
                            '<a class="fl" href="/a/' + url + '" pdata="channel|newsTimely|' + j +'|' + hotNews + '" title="' + title + '" target="_blank"><img class="animation" src="' + imgArr[2].src + '" alt="" width="200" height="150"></a>' +
                            '</p>' +
